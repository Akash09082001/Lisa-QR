            ...
            <form action="" method="post" className="flex w-full flex-col gap-5 items-center justify-center">
                <div className="flex flex-col w-full gap-3">
                    <div className="w-full flex-col flex gap-2">
                        <label htmlFor="name" className="flex text-brand_blue font-semibold text-sm">Enter Your Name</label>
                        <input type="text" name="name" id="name" placeholder="Enter Your name" className="flex w-full border border-gray-300 pl-5 py-2 rounded-lg outline-none" />
                    ...
                    <button type="submit" className="flex text-base font-normal bg-brand_blue text-center items-center justify-center text-white py-2 px-5 w-full rounded-lg ">Register</button>
                </div>
            </form>
